...
<br>
        ...
        <h1 style="position: relative;text-align: center;">Регистрация</h1>
        <div align="center">
        <ul class="niz">
    ...
    ?>
      ...
      <div class="contentRigistr">
		...
		<div class="blockRegistr">
            ...
            <?php  if(isset($smsq)) {  ?><div class="alert-true" role="alert"> <center><?php echo $smsq; ?></center> </div><?php } ?>
            <?php  if(isset($fsmsq)) {  ?><div class="alert-false" role="alert"> <center><?php echo $fsmsq; ?></center> </div><?php } ?>
