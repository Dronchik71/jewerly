...
<body>
    ...
    <br>
        ...
        <h1 style="position: relative;text-align: center;">Моя корзина</h1>
        <div align="center">
        <ul class="niz">
...
<h1 align="center">Ваша корзина пуста</h1><br>
<b><p align="center"><a href="inet.php">Нажмите здесь</a>, чтобы продолжить покупки</p></b><br>
